...
**115 groups** across **20 categories** covering North, South, West, Southwest sides + suburbs.  
**38 groups** have verified contact information. Expanded coverage fills 13 previously uncovered community areas.
...
├── data/
│   ├── groups.csv             # Core directory — 115 groups
